...
draft: false
heroImage: "./images/e8e379db-cec1-43ec-99a8-f314cded3033.png"
---
# Why I got into this?
...
[![Twitter API Doc for showing JSON String shenanigans](./images/9e1f7cce-06c7-4cdd-aea6-530918ffd54b.png)](https://developer.twitter.com/en/docs/twitter-ids)
...
![](./images/68eb33b6-db61-4a9d-9d32-1e8137d907e5.png)
...
![](./images/95d8e78b-e0ce-49a9-a8ac-3868b3e9bbd0.png)
...
* Rules on how JSON input can validate against the given schema. This can be of various types such as TypeValidations, Conditional, Regex Patterns etc
    ...
    ![](./images/9ecd9ff1-5b4b-4dd2-8372-0c70200fbf35.png)
...
![](./images/94ad87c9-4709-42b2-91f8-90b930e96524.png)

1. SuperJSON
    
    ![](./images/a5ff60cd-a678-4204-acdd-f4ed0512ad84.png)
