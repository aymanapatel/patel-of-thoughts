...
[![Twitter API Doc for showing JSON String shenanigans](https://cdn.hashnode.com/res/hashnode/image/upload/v1696758759901/9e1f7cce-06c7-4cdd-aea6-530918ffd54b.png)](https://developer.twitter.com/en/docs/twitter-ids)
...
* Rules on how JSON input can validate against the given schema. This can be of various types such as TypeValidations, Conditional, Regex Patterns etc
  ...
  ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1696782046211/9ecd9ff1-5b4b-4dd2-8372-0c70200fbf35.png)
...
| --- | --- | --- |
| Golang | [go.geojson](https://github.com/paulmach/go.geojson) / [orb](https://github.com/paulmach/orb) | Library for parsing GeoJSON and doing 2d geometric calculations |
| Golang | [geojson](https://github.com/tidwall/geojson) | Used by [tile38](https://tile38.com/) |
| Python | [geojson](https://pypi.org/project/geojson/) | Python utilities for GeoJSON |
| Java | [GeoJSON Jackson](https://github.com/opendatalab-de/geojson-jackson) | Serialize and deserialize GeoJSON POJOs |
...
| C# | [GeoJSON.Net](https://github.com/GeoJSON-Net/GeoJSON.Net) | GeoJSON types and deserializers |
...
[View SuperJSON Example on Replit](https://replit.com/@AymanArif1/Javascript-JSON-Enhancers#SuperJSONExample.js) 
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1696786676496/94ad87c9-4709-42b2-91f8-90b930e96524.png)

**SuperJSON**

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1696786730099/a5ff60cd-a678-4204-acdd-f4ed0512ad84.png)
...
I haven't touched JWT, JSON-LD (RDF), NDJSON, Vega, Avro. One thing is for sure, things are never-ending rabbit hole that requires digging till the end of time.