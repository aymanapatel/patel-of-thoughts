...
draft: false
heroImage: "./images/142b59b7-9e32-4a22-954c-234f528b2860.png"
---
...
![](./images/92e7fbf5-b899-4197-9d4a-a4ce439e2b6f.png)
...
![](./images/2ac40c88-d5b8-4540-a6f5-e26ff7447928.png)
...
1. **Add data to Redis Stream**
    ...
    ![](./images/20678aed-29ba-43f7-9de9-b05976d822d1.png)
    
2. **Create consumer group**
    

![](./images/e39f6b0f-d2ea-4002-a339-11fc321f3baa.png)

1. **Add data to Redis Stream** and **Read from Consumer**
    
    ![](./images/28c416b3-265f-4002-9559-1b4f476f17a7.png)
    
2. **Read the Consumer has received. They can ACK or CLAIM too!**
    
    ![](./images/e9e36c2b-dc4d-46f0-be58-4d79cca8372b.png)
...
![](./images/00429986-9cd5-4d05-99af-47ed1e813cba.png)
...
![](./images/b9128dab-1904-4880-bc5b-df1c2dd50758.png)
