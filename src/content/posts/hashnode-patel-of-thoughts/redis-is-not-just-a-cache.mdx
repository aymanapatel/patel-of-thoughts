...
description: "Redis is not just a Cache! Redis is just not a cache, but a storage ecosystem!"
seoTitle: "Redis is not just a Cache"
date: 2024-02-24
cuid: clt0de3v3000108i97eku2f2m
slug: redis-is-not-just-a-cache
cover: /images/hashnode/142b59b7-9e32-4a22-954c-234f528b2860.png
ogImage: /images/hashnode/6472c987-fe60-4b4d-93da-a03f61ddf443.png
...
![](/images/hashnode/92e7fbf5-b899-4197-9d4a-a4ce439e2b6f.png)
...
![](/images/hashnode/2ac40c88-d5b8-4540-a6f5-e26ff7447928.png)
...
1. **Add data to Redis Stream**
    ...
    ![](/images/hashnode/20678aed-29ba-43f7-9de9-b05976d822d1.png)
    
2. **Create consumer group**
    

![](/images/hashnode/e39f6b0f-d2ea-4002-a339-11fc321f3baa.png)

1. **Add data to Redis Stream** and **Read from Consumer**
    
    ![](/images/hashnode/28c416b3-265f-4002-9559-1b4f476f17a7.png)
    
2. **Read the Consumer has received. They can ACK or CLAIM too!**
    
    ![](/images/hashnode/e9e36c2b-dc4d-46f0-be58-4d79cca8372b.png)
...
![](/images/hashnode/00429986-9cd5-4d05-99af-47ed1e813cba.png)
...
![](/images/hashnode/b9128dab-1904-4880-bc5b-df1c2dd50758.png)
